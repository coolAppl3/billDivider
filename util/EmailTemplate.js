class EmailTemplate {
  verificationEmail(unverifiedUserID, verificationCode) {
    ...
    >
      ...
      <p style="line-height: 22px; margin: 0; margin-bottom: 20px">
        To complete the sign up process, you would need to enter the following email-verification code: <span style="font-weight: bold; color: #8685ef">${verificationCode}</span>. Alternatively, you can click on the following link: <a href="https://billdivider.cc/verification.html?id=${unverifiedUserID}&keepMeSignedIn=&verificationCode=${verificationCode}">https://billdivider.cc/verification.html?id=${unverifiedUserID}&keepMeSignedIn=&verificationCode=${verificationCode}</a>.
      </p>
      <p style="line-height: 22px; margin: 0; margin-bottom: 20px">
  ...
  recoveryEmail(username, userID, recoveryCode) {
    ...
    >
      ...
      <p style="line-height: 22px; margin: 0; margin-bottom: 20px">
        We've received an account recovery request from you. To recover your account, please click the following link: <a href="https://billdivider.cc/updatePassword.html?id=${userID}&recoveryCode=${recoveryCode}">https://billdivider.cc/updatePassword.html?id=${userID}&recoveryCode=${recoveryCode}</a>.
      </p>
      <p style="line-height: 22px; margin: 0; margin-bottom: 20px">If this request wasn't made by you, please ignore this email.</p>
      <p style="line-height: 22px; margin: 0; margin-bottom: 0; padding: 0">Best,</p>
      <p style="line-height: 22px; margin: 0; margin-bottom: 20px">Bill Divider Automated Email Service</p>
